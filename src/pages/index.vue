<template>
  <div class="root">
      ...
      >
        <transition-group tag="div" class="read-list-item" name="list">
          <div @click="redirect(item.url)" v-for="(item) in articles" :key="item.id">
            ...
            <img v-if="item.top" class="zhid" src="~assets/zhiding.jpg" />
          </div>
        </transition-group>
      </VueBetterScroll>
    </div>
    ...
    >
      <van-field center label-width="70" placeholder="请输入您的手机号" v-model="phone" label="手机号"></van-field>

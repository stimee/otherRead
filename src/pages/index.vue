<template>
    <div class="root">
        ...
        <van-dialog class="myDialog" v-model="show" title="文章发布" @confirm='submitArticle' show-cancel-button
                    show-confirm-button>
        ...
        <van-dialog class="myDialog" v-model="showLogin" title="登录" show-cancel-button show-confirm-button

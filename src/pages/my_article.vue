<template>
  <div class="root">
    ...
    <div class="waitReadMsg">我一共发布了n篇文章</div>
    <div class="read-list">
      <VueBetterScroll
        class="wrapper"
        ref="scroll"
          ...
          <div @click="redirect(item.url)" v-for="(item,index) in articles" :key="index">
            ...
            <div>
              <div>
                ...
                <van-button @click="deleteArticle()">下 架</van-button>
              </div>
              <div>
...
import { articles } from 'http/api.js'
export default {
  ...
  created() {
    articles.call(this, { userId: 1396511473 }).then((res) => {
